...
class _RatingsPageState extends State<RatingsPage> {
  ...
  final List<Map<String, dynamic>> _mockRatings = [
    // Motorcycles (5)
    {
      'driver': 'Lito Fast',
      'user': 'Rob Martin',
    ...
    },
    {
      ...
      'user': 'Charlie Brown',
      'rating': 2,
      'comment': 'Rude and drove recklessly.',
    ...
    },
    {
      ...
      'user': 'David Lee',
      'rating': 4,
      'comment': 'Good driver, knows the shortcuts.',
    ...
    },
    {
      ...
      'user': 'Eva Green',
      'rating': 4,
      'comment': 'Smooth ride, nice motorcycle.',
    ...
    // Taxis (5)
    {
      ...
      'user': 'Jane Doe',
      'rating': 3,
      'comment': 'Comfortable car but took the long route.',
      'vehicle': 'Toyota Vios',
      'type': 'Taxi',
    },
    {
    ...
    },
    {
      ...
      'rating': 5,
      'comment': 'Very clean car and polite driver.',
    ...
    },
    {
      ...
      'rating': 2,
      'comment': 'Car smelled a bit weird.',
    ...
    },
    {
      ...
      'user': 'Hannah Abbott',
      'rating': 4,
      'comment': 'Great trip, relaxing music.',
      'vehicle': 'Kia Soluto',
      'type': 'Taxi',
    },
  ];
        ...
        Expanded(
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              final List<Map<String, dynamic>> firestoreRatings = firestoreDocs
                  .map((doc) {
              ...
              final allRatings = [...firestoreRatings, ..._mockRatings];

              // Apply filters
              final searchQuery = _searchController.text.toLowerCase();
              final filtered = allRatings.where((r) {
                final matchesSearch =
                    r['driver'].toLowerCase().contains(searchQuery) ||
                    r['user'].toLowerCase().contains(searchQuery) ||
                    r['vehicle'].toLowerCase().contains(searchQuery);

                final matchesType =
                    _selectedType == 'All' || r['type'] == _selectedType;
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final int ratingValue = (rating['rating'] as num).toInt();
                  ...
                  return Card(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          border: Border(
                            left: BorderSide(color: ratingColor, width: 6),
                          ),
                        ),
                        padding: const EdgeInsets.all(16.0),
                        child: Column(
